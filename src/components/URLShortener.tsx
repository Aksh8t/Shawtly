...
export function URLShortener() {
  ...
  const handleShorten = async () => {
    ...
    setTimeout(() => {
      setShortUrl(
        `https://shawtly.co/${Math.random().toString(36).substr(2, 8)}`
      );
      setIsLoading(false);
    }, 1000);
  };
  ...
  return (
    <section className="pt-24 pb-16 px-4 relative overflow-hidden">
      ...
      <div className="absolute inset-0 bg-lovable opacity-90" />
      ...
      <div className="container max-w-4xl mx-auto relative z-10">
        <div className="text-center mb-12 animate-fade-in">
          ...
          <p className="text-lg text-white/80 max-w-2xl mx-auto">
            Shorten URLs, track analytics, and create custom QR codes with
            payment options.
          </p>
        </div>
            ...
            {shortUrl && (
              <div className="animate-fade-in">
                ...
                <div className="flex justify-center gap-4 mt-6">
                  <Button
                    variant="outline"
                    className="transition-smooth hover:bg-white hover:text-black"
                  >
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in relative z-10">
          <div className="text-center">
            ...
            <p className="text-white/70">
              Create short, memorable links with custom aliases
            </p>
          </div>

          <div className="text-center">
            <div
              className="w-16 h-16 bg-white rounded-full flex items-center justify-center mx-auto mb-4 animate-float"
          ...
          <div className="text-center">
            ...
            <p className="text-white/70">
              Generate custom QR codes with payment options
            </p>
          </div>
        </div>
      </div>
